...
Return the keywords hash;

This function download Perl keyword html file from learn.perl.org and find keyword;
...
Find which special char appear first, the special chars are: double quote, single quote and hash;
